...
const AdminRestaurantPurchases = ({
  restaurantPurchases,
  complexes,
  onRefresh,
  setViewingRecord,
  ...
  const updateRestaurantPurchaseStatus = async (purchaseId, status) => {
    ...
    const statusMessage = status === 'confirmed' 
      ? 'Are you sure you want to confirm this restaurant purchase?'
      : 'Are you sure you want to cancel this restaurant purchase?';
    ...
    try {
      ...
      Swal.fire({
        ...
        text: `The restaurant purchase has been ${statusText}ed successfully.`,
  ...
  const getUniqueItemNames = () => {
    ...
    restaurantPurchases.forEach(purchase => {
  ...
  const getFilteredPurchases = () => {
    let filtered = restaurantPurchases;
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => {
                ...
                setCurrentPage(prev => ({ ...prev, restaurantPurchases: 1 }));
              }}
...
export default AdminRestaurantPurchases;
